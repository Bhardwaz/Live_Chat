...
const LiveChat = () => {
  ...
  return (
    <div className='flex flex-col gap-5'>
        <div className=' scrollbar scrollbar-thumb-blue-700 scrollbar-track-gray-400 rounded-lg hover:scrollbar-thumb-blue-600 active:scrollbar-thumb-blue-500 flex flex-col-reverse gap-2 justify-start w-[400px] h-[80vh] bg-gray-100 overflow-scroll mx-auto items-start'>
